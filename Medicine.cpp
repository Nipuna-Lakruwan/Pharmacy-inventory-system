	...
	add:
		...
		if (askInput == 1)
		{
			...
			if (this->searching(id) == true)
			{
				...
				cout << endl
						 << " The ID is already exist... Pleadt try again..." << endl;
				getch();
				goto add;
			}
			else
		...
		else
		{
			...
			cout << endl
					 << " Medicine : " << medic.medicineDetail.getTitle() << " add successful!!" << endl;
		}
		w.close();
		test = 0;
		cout << endl
	...
	void editMedicine()
	{
		...
		if (this->medicineList())
		{
			...
			if (oldf == "0")
			{
				cout << endl
						 << endl
						 << " Currently do not insert for any record..." << endl;
			}
			else
			{
				r.close();
				if (!searching(id))
				{
					cout << endl
							 << endl
							 << " The id " << id << " is not found... Please try again..." << endl;
				}
				else
				{
		...
		if (this->medicineList())
		{
			...
			else
			{
				...
				if (!searching(id))
				{
					cout << endl
							 << endl
							 << " The Medicine : " << id << " is not found... Please try again..." << endl;
					id = "0";
				}
				else
				{
						...
						if (id == medic.medicineDetail.getId())
						{
							while (choose == '0')
							{
								...
								cout << "-------------------------------------------------------------------------" << endl
										 << endl;
								cout << endl
										 << " Are you sure to delete the record? [Y/N] " << endl;
								choose = getch();
								if (choose == 'N' || choose == 'n')
								{
									cout << endl
											 << " The record is still remain." << endl;
									this->writeToFile();
								}
	...
	void clearMedicine()
	{
		if (this->medicineList())
		{
			...
			while (choose == '0')
			{
				system("cls");
				cout << endl
						 << " All the rocord can not be recovery after clear..." << endl;
				...
				if (choose == 'Y' || choose == 'y')
				{
					...
					else
					{
						...
						else
						{
							...
							cout << endl
									 << endl
									 << " All the record had been clear..." << endl;
						}
					}
				}
				else if (choose == 'N' || choose == 'n')
				{
					cout << endl
							 << endl
							 << " The record is still remain. Thank you!!" << endl;
				}
				else
				{
					MedicineType::alert(1, "confirmation");
					...
					else
					{
						...
						if (clear != "0")
						{
							...
							if (test == 2)
							{
								...
								cout << endl
										 << endl
										 << " Medicine record for type " << clear << " is clear!!" << endl;
							}
							else if (test == 3)
							{
								this->updateMedicine();
