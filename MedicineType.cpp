...
public:
			...
			if (openfr(1, "type_list.txt") != "0")
			{
				while (getline(r, _type) != 0)
				{
					if (_type == type)
					{
						...
						cout << endl
								 << " The type is already inserted..." << endl;
						type = "existed";
					}
				}
			}
	...
	int displayType(string type)
	{
		...
		if (openfr(1, "type_list.txt") == "0")
		{
			...
			if (type == "add")
			{
				cout << endl
						 << endl
						 << endl
						 << " \t\t99 >> To add new medicine type" << endl
						 << endl;
				cout << " \t\t0 >> Go Back" << endl;
				cout << endl
						 << " \t"
		...
		else
		{
			...
			cout << endl
					 << " \t"
					 << " Choose a medicien type to " << type << " : ";
	...
	string deleteType()
	{
		...
		else
		{
			...
			{
				cout << endl
						 << " All the medicine record for this type will be clear!!!" << endl;
				...
				if (confirm == 'Y' || confirm == 'y')
				{
					...
					if (test == 2)
					{
						...
						cout << endl
								 << endl
								 << " The type of " << del << " is deleted!" << endl;
					}
					if (test == 3)
					{
						this->loading("Deleting", 2, "");
				...
				{
					cout << endl
							 << " The type of " << del << " is still remain." << endl;
					del = "0";
				}
				else
				{
